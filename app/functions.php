        ...
        if ($rowData = mysqli_fetch_assoc($resultData)) {
            ...
            if (!$pwdCheck) {
                ...
                if ($rowData['status_user'] == 0) {
                    echo "<script type='text/javascript'> alert('Akun anda masih nonaktif! Harap chat admin melalui layanan Tawk.to. Tunggu hingga admin mengaktifkan akun anda!'); document.location.href = 'index.php'; </script>";
                    exit();
                }
