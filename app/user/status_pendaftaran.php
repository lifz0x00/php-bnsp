...
<head>
    ...
    <title>Status Pendaftaran PSB ALIF</title>
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
                <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
                    ...
                    <div class="btn-group me-2">
                        <a href="../functions.php?type=export&export=status-pendaftaran-siswa&user_id=<?= $_SESSION['user_id'] ?>" class="btn btn-sm btn-outline-secondary">Export PDF <i class="fas fa-file-export"></i></a>
                    </div>
                </div>
                <div id="content">
