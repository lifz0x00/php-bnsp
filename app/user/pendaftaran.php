<?php
    ...
    $query = mysqli_query($conn, "SELECT * FROM data_pendaftaran WHERE user_id = '{$_SESSION['user_id']}'");
    $data = mysqli_fetch_assoc($query);

    // Cek jika sudah submit berkas
    $sql = mysqli_query($conn, "SELECT * FROM data_pendaftaran WHERE user_id = '{$_SESSION['user_id']}'");
...
<head>
    ...
    <title>Pendaftaran Siswa Baru PSB ALIF</title>
                ...
                <div id="content">
                    <?php if ($count != 0) : ?>
                        <div class="alert alert-success" role="alert">
                            Anda telah mengupload semua berkas! Silahkan cek status pendaftaran Anda <a href="status_pendaftaran.php" class="alert-link">disini.</a>
                        </div>
                    ...
                    <?php else : ?>
                        ...
                        <form action="../functions.php" method="post" enctype="multipart/form-data">
                            <input type="hidden" name="type" value="pendaftaranSiswa">
                                ...
                                <table class="table table-borderless table-hover">
                                    <tr>
                                        <td>
                                            <div class="row g-3">
                                                <div class="col-4">
                                                    <label class="form-label" for="pas_foto">Pas Foto (3x4) <b>*</b></label>
