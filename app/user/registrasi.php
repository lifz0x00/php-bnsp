<?php
    ...
    $query = mysqli_query($conn, "SELECT * FROM users_tb WHERE user_id = '{$_SESSION['user_id']}'");
...
<head>
    ...
    <title>Registrasi Akun PSB ALIF</title>
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
                ...
                <div id="content">
                    ...
                    <form action="../functions.php" method="POST">
                        <input type="hidden" name="type" value="registrasiSiswa">
                        ...
                        <div class="table-responsive">
                            <table class="table table-hover">
                                <tr>
                                    ...
                                    <td>
                                        <label class="form-label" for="nisn">No. Identitas (NIK)</label>
                                        <input class="form-control" readonly type="text" name="nisn" id="nisn" placeholder="No. Identitas (NIK)" value="<?= !empty($data['nik']) ? $data['nik'] : '-' ?>">
                                    </td>
                                    <td>
