<?php
    ...
    $count_nonactive = mysqli_num_rows(mysqli_query($conn, "SELECT * FROM users_tb WHERE status_user = 0;"));
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
                <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
                    ...
                    <div class="btn-group me-2">
                        <a href="../functions.php?type=export&export=inf-pendaftaran&user_id=" class="btn btn-sm btn-outline-secondary" target="_blank">Export PDF <i class="fas fa-file-export"></i></a>
                    </div>
                </div>
                <div id="content">
                    <div class="text-center align-items-center">
                        <?php if (!empty($count_nonactive)) : ?>
                            <div class="alert alert-warning alert-dismissible fade show" role="alert">
                                Terdapat <strong><?= $count_nonactive ?></strong> buah user yang masih nonaktif. Aktifkan user <a href="informasi_user.php" class="alert-link">sekarang!</a>
                                ...
                                <?php foreach ($query as $d) : ?>
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="hapus.php?user_id=<?= $d['user_id'] ?>" onclick="return confirm('Apakah anda yakin ingin menghapus ini ?')" class="btn btn-sm btn-outline-danger">Hapus</a>
                                        </td>
                                    </tr>
                                <?php
                                    $i++;
