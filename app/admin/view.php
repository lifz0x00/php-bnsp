<?php
    ...
    // Get data
    $id = mysqli_real_escape_string($conn, $_GET['pendaftaran_id']);
    $query = mysqli_query($conn, "SELECT * FROM data_pendaftaran INNER JOIN users_tb ON data_pendaftaran.user_id = users_tb.user_id WHERE pendaftaran_id = '$id'");
        ...
        <div class="row">
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
                <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
                    <h3>Detail Berkas <?= $data['nama'] . " (NIK: $data[nik])" ?></h3>
                </div>
                <div id="content">
                    ...
                    <div class="text-center align-items-center">
                        ...
                        <?php if ($_GET['type'] == 'pas_foto') : ?>
                            <embed src="../berkas/<?php echo $data['pas_foto'];?>" type="image/jpg" width="800" height="600" >
                        <?php elseif ($_GET['type'] == 'ijazah') : ?>
                            <embed src="../berkas/<?php echo $data['ijazah'];?>" type="application/pdf" width="800" height="600" >
                        <?php elseif ($_GET['type'] == 'surat_pernyataan') : ?>
                            <embed src="../berkas/<?php echo $data['surat_pernyataan'];?>" type="application/pdf" width="800" height="600" >
                        <?php endif; ?>
                    </div>
                </div>
            </main>
